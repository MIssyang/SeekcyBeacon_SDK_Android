...
public class MonitorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		skyBeaconManager
				.setMonitoringBeaconsListener(monitoringBeaconsListener);
	...
	private void startMonitoring() {
		skyBeaconManager.startScanService(new ScanServiceStateCallback() {
			...
			public void onServiceConnected() {
				// TODO Auto-generated method stub
				skyBeaconManager.startMonitoringBeacons(MONITOR_REGION_TEST);
			}
		});
	}
	...
	private void stopMonitoring() {
		if (skyBeaconManager != null) {
			...
			skyBeaconManager.stopMonitoringBeacons(MONITOR_REGION_TEST);
		}
	}
}
